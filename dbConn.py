...
def Connect():
	try:
		...
		user = 'Autar3Inno'
		password = 'ijQ84mTO'
		database = 'Autar3Innovations'


		connection = pymssql.connect(server='84.246.4.143:9135', user='Autar3Inno', password='ijQ84mTO', database='Autar3Innovations')
		#cursor = connection.cursor() 

		#con_string = 'DSN=%s;UID=%s;PWD=%s;DATABASE=%s;' % (dsn, user, password, database)

		#con_string="DRIVER={/opt/microsoft/msodbcsql17/lib64/libmsodbcsql-17.0.so.1.1};SERVER=84.246.4.143;UID=Autar3Inno;PWD=ijQ84mTO;DATABASE=Autar3Innovations"
		#connection=pymysql.connect(host='localhost',user='rakaut',password='ijQ84mTO',db='innovation')
		#connection= pyodbc.connect(con_string)
		#connection= pyodbc.connect(DSN=InnoDB,PORT=9135,UID=Autar3Inno,PWD=ijQ84mTO,DATABASE=Autar3Innovations)
		debugprint("Leaving")
		return connection
	except:
